...
function addItemToCart(title, price) {
    ...
    var cartRowContents = `
        ...
        一位:<span class="cart-price cart-column">${price}</span></div>
        <div class="cart-quantity cart-column">
            參加人數：<input class="cart-quantity-input" type="number" value="1">
            <button class="btn btn-danger" type="button">刪除</button><hr>
